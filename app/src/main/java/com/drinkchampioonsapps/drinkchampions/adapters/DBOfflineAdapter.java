package com.drinkchampioonsapps.drinkchampions.adapters;
...
import com.drinkchampioonsapps.drinkchampions.ui.DataBaseOfflineHelper;

public class DBOfflineAdapter {
	//Campos de la BD
	...
	private static final String DATABASE_TABLE = "offline";
	private Context context;
	private SQLiteDatabase database;
	private DataBaseOfflineHelper dbHelper;

	public DBOfflineAdapter(Context context) {
		this.context = context;
	}

	public DBOfflineAdapter open() throws SQLException {
		dbHelper = new DataBaseOfflineHelper(context);
	...
	public void close() {
		database.execSQL("delete from offline");
	...
	*/
	...
	public Cursor selectrebundace(String summary) {

		Cursor select = database.rawQuery("SELECT summary FROM offline where summary="+summary+":",null);
		return select;

	}

	public Cursor selecall() {

		Cursor all = database.rawQuery(" SELECT * FROM offline ", null);
		return all;
	}
