...
public class Comidas {
    ...
    public static List<ToDoItem> getlikes() {
        return Prinicpal2;
    }
    ...
    static {
      ...
      Principales.add(new Comida(2.0f, "Amstel Radler", R.drawable.amstelradler,"Amstel Radler está compuesta de un 40% cerveza\n" +
              ...
              "“Radler” (ciclista en alemán)!",5f,1,"http://www.amstel.es/nuestras-cervezas/amstel-radler-con-limon/","",""));
