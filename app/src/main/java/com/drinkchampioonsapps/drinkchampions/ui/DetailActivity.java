...
import com.drinkchampioonsapps.drinkchampions.activities.StreetViewActivity;
...
public class DetailActivity extends AppCompatActivity {
    ...
    private FloatingActionButton street;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        street=(FloatingActionButton) findViewById(R.id.fab_street_view);
    ...
    private void setupViews(List<ToDoItem> items, int position) {
        ...
        liked = detailCourse.getPositions();
...
*/
    ...
    public void saveb(View v){
        ...
        if (liked==0) {
            ...
            String imagedir = detailCourse.getImagedir();
